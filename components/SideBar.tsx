      ...
      {isDesktop == false && isMobileMenuOpen && (
        ...
        >
          <motion.div
            ...
            className="flex h-screen w-full flex-col justify-between bg-void-black p-2 text-off-white"
          >
            ...
            <div className="relative z-20 space-y-[14px] pb-1.5">
              ...
              <Link
                ...
                href="mailto:Info@BaroroStudio.com"
              >
                <span>Info@BaroroStudio.com</span>
                <Arrow fill="#f8f8f8" />
