...
export default function News() {
  const listItems = [
    {
      href: "/blog/riot-games-collaboration",
      ...
      title: "BARORO STUDIO PARTNERS WITH RIOT GAMES ON LEAGUE OF LEGENDS MUSIC VIDEO",
      description: {
        desktop: [
    ...
    },
    {
      ...
      title: "INTRODUCING/ BARORO STUDIO EDITIONS",
      description: {
